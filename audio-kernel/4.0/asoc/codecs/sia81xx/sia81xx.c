...
/*zengjianxiong@ODM_LQ@Multimedia.Audio,2020/05/22,modified for compatie Athens and Plato*/
...
{	
    ...
    #ifndef ODM_TARGET_DEVICE_206B1
    /*zengjianxiong@ODM_LQ@Multimedia.Audio,2020/05/22,modified for compatie Athens and Plato PA*/
    if (!is_project(OPPO_206B1))
        return ret;
    #endif
