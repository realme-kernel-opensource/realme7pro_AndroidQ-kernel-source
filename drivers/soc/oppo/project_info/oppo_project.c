...
#ifdef ODM_LQ_EDIT
/*xujun@ODM_LQ@BSP.Boardid,2020/03/02 ,add reserve for cdt operatorName*/
#define OPERATOR_RESERVE	(0xB)
#endif /*ODM_LQ_EDIT*/
...
#ifdef ODM_LQ_EDIT
/*xujun@ODM_LQ@BSP.Boardid,2020/03/02 ,add reserve for cdt operatorName*/
unsigned char get_Operator_Reserve(void)
{
	init_project_version();
	return g_project?g_project->nReserve:0;
}
#endif /*ODM_LQ_EDIT*/
...
static int project_read_func(struct seq_file *s, void *v)
{
	...
	case PROJECT_TEST:
        ...
        case OPERATOR_RESERVE:
	       seq_printf(s, "%d", get_Operator_Reserve());
	       break;
        #endif /*ODM_LQ_EDIT*/
...
static int __init oppo_project_init(void)
{
	...
	if (!p_entry)
        ...
        #ifdef ODM_LQ_EDIT
        /*xujun@ODM_LQ@BSP.Boardid,2020/03/02 ,add reserve for cdt operatorName*/
	p_entry = proc_create_data("operatorCDT", S_IRUGO, oppo_info, &project_info_fops, UINT2Ptr(OPERATOR_RESERVE));
	if (!p_entry)
		goto error_init;

        /*xujun@ODM_LQ@BSP.Bootflow,2020/05/20 ,add prjName*/
