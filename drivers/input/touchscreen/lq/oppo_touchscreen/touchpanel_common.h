...
/* modify begin by zhangchaofan@ODM_LQ@Multimedia.TP, remove tp pinctrl 2020-02-20 */
    //pinctrl
    //struct pinctrl          *pinctrl;
    //struct pinctrl_state    *pin_set_high;
    //struct pinctrl_state    *pin_set_low;
    //struct pinctrl_state    *pin_set_nopull;
/* modify end by zhangchaofan@ODM_LQ@Multimedia.TP, remove tp pinctrl 2020-02-20 */
};
