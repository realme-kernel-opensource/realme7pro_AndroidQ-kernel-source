...
//    ts_data->uniformity_rawdata = (int *)kzalloc(node_num * sizeof(int), GFP_KERNEL);
//    if (!ts_data->uniformity_rawdata) {
//        FTS_TEST_SAVE_ERR("kzalloc for uniformity_rawdata fail");
//        goto alloc_err;
//    }
...
//    if (ts_data->uniformity_rawdata) {
//        kfree(ts_data->uniformity_rawdata);
//        ts_data->uniformity_rawdata = NULL;
//    }
    if (ts_data->rawdata) {
